            ...
            <div class="flex flex-col md:flex-row gap-2 md:items-center justify-between">
                <div :class="{ 'opacity-25': listing.deleted_at }">
                    <div
                        ...
                        class="text-xs font-bold uppercase border border-dashed p-1 inline-block rounded-md mb-2 border-green-300 text-green-500 dark:border-green-600 dark:text-green-600"
                    >
                        sold
                    </div>
                ...
                <section>
                    <div class="flex items-center gap-1 text-gray-600 dark:text-gray-300">
                        <a class="btn-outline text-xs font-medium" :href="route('listing.show', { listing: listing.id })" target="_blank"
                            >Preview</a
                        >
                        <Link
